defmodule ApiMonitorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ApiMonitorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ApiMonitorWeb.Gettext, "errors", msg, opts)
    end
  end
