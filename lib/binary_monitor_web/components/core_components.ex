defmodule BinaryMonitorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BinaryMonitorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BinaryMonitorWeb.Gettext, "errors", msg, opts)
    end
  end
